    ...
    <DashboardLayout>
      <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center">
        ...
        >
          ...
          <h1 className="text-3xl font-black text-on-surface mb-4">Tenants</h1>
          <p className="text-on-surface-variant mb-8 font-medium">
            This module is coming soon. You'll be able to manage all your tenants, screening, and communication from here.
          </p>
