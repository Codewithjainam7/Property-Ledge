...
import { Building, Plus, MapPin, Search, Filter, Home, ArrowUpRight, CheckCircle2, Clock, LayoutGrid, List, ChevronDown, X, Edit2 } from 'lucide-react';
        ...
        <div className="px-6 md:px-10 max-w-[1600px] mx-auto relative z-10">
          ...
          {dataLoading ? (
            ...
            <div className="text-center py-20 bg-surface rounded-3xl border border-outline-variant/30 mt-4 shadow-sm">
              ...
              {!searchQuery && userContext?.isLandlordOrTeam && (
                <button 
                  onClick={() => setIsAddModalOpen(true)}
